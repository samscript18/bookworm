...
import { changePassword, editProfile, reactToUser, getProfile, updatePreferences, updateFcmToken, removeFcmToken, getNotifications } from "../controllers/user.controller";
...
userRoutes.get("/me/notifications", [authMiddleware, authLimiter], getNotifications);
