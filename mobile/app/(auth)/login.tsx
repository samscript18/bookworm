			...
			<TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
				<KeyboardAvoidingView className="flex-1" behavior={Platform.OS === "ios" ? "padding" : "height"}>
					...
					<View className="mt-10">
						...
						<TouchableOpacity className="mt-[10px] items-center rounded-2xl p-4" style={{ backgroundColor: theme.colors.primary }} onPress={handleLoginPress} disabled={isSubmitting || isloggingIn}>
